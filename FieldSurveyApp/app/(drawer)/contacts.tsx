...
export default function ContactsScreen() {
  ...
  const getContacts = async () => {
    try {
      ...
      if (status !== "granted") {
        Alert.alert("Permission Denied", "Contacts permission is required to access your contacts.");
      ...
      <View style={styles.contactCard}>
        ...
        <View style={styles.contactInfo}>
          ...
          <View style={styles.phoneRow}>
            ...
            <Text style={styles.phoneNumber}>{phoneNumber || "No phone number"}</Text>
          </View>
        </View>

        {/* Copy Button */}
        {phoneNumber && (
          <AnimatedPressable style={styles.copyButton} onPress={() => copyNumber(phoneNumber)}>
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>Search and select contacts for your field survey.</Text>
          ...
          <View style={styles.summaryCard}>
            <View style={styles.summaryIcon}>
              <Ionicons name="people" size={21} color={colors.primaryLight} />
            </View>

            <View style={styles.summaryInfo}>
              <Text style={styles.summaryLabel}>Total Contacts</Text>

              <Text style={styles.summaryCount}>{filteredContacts.length}</Text>
            </View>

            <AnimatedPressable style={styles.refreshButton} onPress={onRefresh}>
          ...
          <View style={styles.sectionHeader}>
            ...
            {search.length > 0 && <Text style={styles.resultText}>Search results</Text>}
          </View>
            ...
            ListEmptyComponent={
              <View style={styles.empty}>
                <View style={styles.emptyIcon}>
                  <Ionicons name="people-outline" size={35} color={colors.primaryLight} />
                </View>

                <Text style={styles.emptyTitle}>No Contacts Found</Text>

                <Text style={styles.emptyText}>
                  {search ? "Try searching with a different contact name." : "No contacts are available on your device."}
                </Text>
              </View>
            }
          />
